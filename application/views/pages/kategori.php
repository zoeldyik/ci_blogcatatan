<div class="container mt-3 mt-md-5" id="content">
    ...
    <div class="col-md-5 p-0">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" id="breadcumb">
                <li class="breadcrumb-item"><a href="<?= base_url('home/homepage'); ?>">All kategori</a></li>
        ...
        <div class="col-12 col-md-7">
            ...
            <div class="card mb-1">
                ...
                <div class="card-body d-none">
                    ...
                    <a class="badge badge-success p-2" href="<?= base_url(); ?>home/edit/<?= $data['id']; ?>">edit</a>
